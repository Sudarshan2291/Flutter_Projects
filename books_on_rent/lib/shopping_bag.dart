...
import 'package:books_on_rent/checkout_screen.dart';
...
class _ShoppingBagState extends State<ShoppingBag> {
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        setState(() {
                          log("AppdataModal.listcart[index]:  ${AppdataModal.listcart[index]}");
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) =>
                    CheckoutScreen(amount: (totalamount + 10)),
              ));
            },
            child: Center(
              child: Container(
  ...
  Widget summaryRow(String title, num value) {
    return Row(
      children: [
        Text(
          title,
