...
class Detailpage extends StatefulWidget {
  final Map mapBook;
  final int index;
  const Detailpage({required this.mapBook, required this.index, super.key});
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 250,
                      child: Expanded(
                        child: Text(widget.mapBook['cardname'],
                    ...
                    SizedBox(
                      ...
                      child: Expanded(
                        child: Text(
                            "₹ ${widget.mapBook['price'].toString()}/Day",
                            style: GoogleFonts.quicksand(
                                fontSize: 22,
                                fontWeight: FontWeight.w800,
                                color: Colors.black)),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 20),
                    Text(
                      "Total: ₹ ${widget.mapBook['price'] * con * con1}",
                      style: GoogleFonts.quicksand(
              ...
              _buildActionButton("Add To Cart", () {
                widget.mapBook['count'] = con;
                widget.mapBook['days'] = con1;
                AppdataModal.listcart.add(widget.mapBook);
              ...
              _buildActionButton("Checkout", () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) {
                  return CheckoutScreen(amount: widget.mapBook['price']);
                }));
              }),
            ],
          ),
